...
CREATE TABLE IF NOT EXISTS `TTPT`.`ESTUDIANTE` (
  ...
  `copiaCI` TINYINT(1) NOT NULL DEFAULT 0,
...
BEGIN
	...
	start transaction;
		...
		insert into estudiante (`idESTUDIANTE`,`FotosCarnet`,`CertEstudios`,`CertNotarial`,`copiaCI`)
					values (nroReg, n_fotos, c_estudios, c_notarial,c_CI);
