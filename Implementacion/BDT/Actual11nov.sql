...
CREATE TABLE `area` (
  ...
  `Alias` varchar(45) NOT NULL COMMENT 'Representa al código que se usa para identificar producto que pertenece al área.',
  PRIMARY KEY (`Nombre`)
...
INSERT INTO `area` VALUES ('Licencia de conducir clase A-2','A-2'),('Licencia de conducir clase A-3','A-3'),('Licencia de conducir clase A-4','A-4'),('Licencia de conducir clase A-5','A-5'),('Licencia de conducir clase B','B'),('Licencia de conducir clase D','D');
...
CREATE TABLE `atencion_cliente_potencial` (
  ...
  `Metodo` varchar(3) NOT NULL COMMENT 'Se refiere a si la atención fue en',
...
INSERT INTO `curso` VALUES ('A2-001','A2-001','2014-06-12','2014-07-12'),('A2-002','A2-002','2014-06-12','2014-07-12'),('A3-001','A3-001','2014-06-12','2014-07-12'),('A4-001','A4-001','2014-06-12','2014-07-12'),('B-001','B-001','2014-06-12','2014-07-12'),('D-001','D-001','2014-06-12','2014-07-12');
...
INSERT INTO `docente` VALUES (6,'Jacob Fernández Becerra','79533765','pro'),(7,'Joselín Vasquez Solórzano','96678553','pro'),(8,'Bernardina Farías Velez','91262085','ins'),(9,'Nurit Curiel Quiñónez','79089190','ins');
...
CREATE TABLE `funcionario` (
  ...
  `Nombre` varchar(45) NOT NULL,
  `Tipo` varchar(3) NOT NULL COMMENT 'crear trigger on insert',
...
INSERT INTO `funcionario` VALUES (1,'Luis Barrientos Fajardo','adm'),(2,'Kurt Poehler','adm'),(3,'José Luis Acuña','adm'),(4,'Vanya Ávila Díaz','off'),(5,'Melisa Carmona Anaya','off'),(6,'Jacob Fernández Becerra','doc'),(7,'Joselín Vasquez Solórzano','doc'),(8,'Bernardina Farías Velez','doc'),(9,'Nurit Curiel Quiñónez','doc');
...
INSERT INTO `producto` VALUES ('A2-001','Licencia de conducir clase A-2'),('A2-002','Licencia de conducir clase A-2'),('A3-001','Licencia de conducir clase A-3'),('A4-001','Licencia de conducir clase A-4'),('B-001','Licencia de conducir clase B'),('B-002','Licencia de conducir clase B'),('D-001','Licencia de conducir clase D');
...
INSERT INTO `profesor` VALUES (6),(7);
...
INSERT INTO `teoria` VALUES (1,'A2-001','08:00:00',45,6),(2,'A2-001','14:00:00',45,6),(3,'A2-002','08:00:00',45,7),(4,'A2-002','14:00:00',45,7),(5,'B-001','09:00:00',45,7),(6,'B-001','10:00:00',45,6),(7,'D-001','19:00:00',45,7);
...
INSERT INTO `tipo_usuario` VALUES ('Administrador'),('Tipo1'),('Tipo2');
...
INSERT INTO `usuario` VALUES ('Luzhow','1234asd','Administrador',0);
...
-- Dump completed on 2014-11-12  1:59:47
