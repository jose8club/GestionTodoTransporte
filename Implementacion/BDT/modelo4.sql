...
START TRANSACTION;
USE `TTPT`;
INSERT INTO `TTPT`.`FUNCIONARIO` (`idFUNCIONARIO`, `Nombre`, `Tipo`) VALUES (0, 'Cristina', 'Recepcion');
INSERT INTO `TTPT`.`FUNCIONARIO` (`idFUNCIONARIO`, `Nombre`, `Tipo`) VALUES (1, 'Genoveva', 'Recepción');
INSERT INTO `TTPT`.`FUNCIONARIO` (`idFUNCIONARIO`, `Nombre`, `Tipo`) VALUES (2, 'Paulina', 'Administrativo');
INSERT INTO `TTPT`.`FUNCIONARIO` (`idFUNCIONARIO`, `Nombre`, `Tipo`) VALUES (3, 'Cristofer', 'Administrativo');
INSERT INTO `TTPT`.`FUNCIONARIO` (`idFUNCIONARIO`, `Nombre`, `Tipo`) VALUES (5, 'Janette', 'Gerencia');
INSERT INTO `TTPT`.`FUNCIONARIO` (`idFUNCIONARIO`, `Nombre`, `Tipo`) VALUES (4, 'Juan Carlos', 'Gerencia');
INSERT INTO `TTPT`.`FUNCIONARIO` (`idFUNCIONARIO`, `Nombre`, `Tipo`) VALUES (6, 'Jorge Palma', 'Docente');
INSERT INTO `TTPT`.`FUNCIONARIO` (`idFUNCIONARIO`, `Nombre`, `Tipo`) VALUES (7, 'José Matus', 'Docente');
INSERT INTO `TTPT`.`FUNCIONARIO` (`idFUNCIONARIO`, `Nombre`, `Tipo`) VALUES (8, 'Otto Müller', 'Docente');
INSERT INTO `TTPT`.`FUNCIONARIO` (`idFUNCIONARIO`, `Nombre`, `Tipo`) VALUES (9, 'Nestor', 'Docente');
...
INSERT INTO `TTPT`.`AREA` (`Nombre`, `Alias`) VALUES ('Profecional', 'INTENSIVO');
...
INSERT INTO `TTPT`.`PRODUCTO` (`Nombre`, `Area`) VALUES ('Otro', 'Otros');
...
START TRANSACTION;
USE `TTPT`;
INSERT INTO `TTPT`.`AUTO-ESCUELA` (`Matricula`, `Modelo`, `Estado`) VALUES ('GYIH04', 'V16', 'Disponoble');
INSERT INTO `TTPT`.`AUTO-ESCUELA` (`Matricula`, `Modelo`, `Estado`) VALUES ('CFEA46', 'V16', 'Disponoble');
INSERT INTO `TTPT`.`AUTO-ESCUELA` (`Matricula`, `Modelo`, `Estado`) VALUES ('KNDC29', 'V16', 'Disponoble');
INSERT INTO `TTPT`.`AUTO-ESCUELA` (`Matricula`, `Modelo`, `Estado`) VALUES ('AIWP64', 'V16', 'Disponoble');
INSERT INTO `TTPT`.`AUTO-ESCUELA` (`Matricula`, `Modelo`, `Estado`) VALUES ('WTYN26', 'V16', 'Disponoble');
INSERT INTO `TTPT`.`AUTO-ESCUELA` (`Matricula`, `Modelo`, `Estado`) VALUES ('UIHM09', 'Chevrolet', 'Disponoble');
INSERT INTO `TTPT`.`AUTO-ESCUELA` (`Matricula`, `Modelo`, `Estado`) VALUES ('ATMZ80', 'Chevrolet', 'Disponoble');
INSERT INTO `TTPT`.`AUTO-ESCUELA` (`Matricula`, `Modelo`, `Estado`) VALUES ('NEKH99', 'Chevrolet', 'Disponoble');
INSERT INTO `TTPT`.`AUTO-ESCUELA` (`Matricula`, `Modelo`, `Estado`) VALUES ('ZUYY89', 'Chevrolet', 'Disponoble');
INSERT INTO `TTPT`.`AUTO-ESCUELA` (`Matricula`, `Modelo`, `Estado`) VALUES ('OBEP72', 'Chevrolet', 'Disponoble');
